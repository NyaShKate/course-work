...
User.create(email: "test3@test.com", password: "test3", name: "Bob")
User.create(email: "test4@test.com", password: "test4", name: "Mary")
User.create(email: "test5@test.com", password: "test5", name: "Tom")
